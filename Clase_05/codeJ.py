...
class ListBoxWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        link = Gtk.LinkButton("https://www.google.com","Go to Java tutorial") 
        ...
        link = Gtk.LinkButton.new_with_label("https://www.google.com","Go to C tutorial") 
        hbox.pack_start(label, True, True, 0)
        hbox.pack_start(link, False, True, 0)
        listbox.add(row)
        ...
        link1 = Gtk.LinkButton("https://www.google.com","Go to JavaScript tutorial") 
        hbox.pack_start(label, True, True, 0)
        hbox.pack_start(link, False, True, 0)
        listbox.add(row)
        ...
        link2 = Gtk.LinkButton.new_with_label("Go to Python tutorial") 
        hbox.pack_start(label, True, True, 0)
        hbox.pack_start(link, False, True, 0)
